  ...
  <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="col-span-2">
          <div>
            ...
            <p className="mt-4 text-white">
              Be the first to get our updates, Stay connected to Flux!!
            </p>
          </div>
        </div>
          ...
          <form className="w-full">
            ...
            >
              <input
                ...
                className="w-full border-none bg-white focus:border-transparent focus:ring-transparent sm:text-sm p-4"
              />
    ...
    <div className="mt-8 border-t border-gray-100 pt-8">
      <div className="sm:flex sm:justify-between">
        <p className="text-xs text-white">&copy; 2024. Flux Logistics. All rights reserved.</p>
